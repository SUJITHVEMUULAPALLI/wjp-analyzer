...
class LoggingManager:
    ...
    def _resolve_logs_dir(self, desired: str) -> str:
        """Choose a user-writable logs directory, falling back if needed."""
        try:
    ...
    def _setup_root_logger(self):
        ...
        desired_logs_dir = self.config.get('logs_folder', 'logs')
        ...
        log_dir = self._resolve_logs_dir(desired_logs_dir)
        ...
        try:
            ...
            # Skip error file if not writable
            pass
