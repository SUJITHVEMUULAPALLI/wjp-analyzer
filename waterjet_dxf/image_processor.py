#!/usr/bin/env python3
"""
Image to DXF Converter for Waterjet Cutting
==========================================

Converts bitmap images to DXF format suitable for waterjet cutting.
Uses edge detection and contour extraction to create cutting paths.
"""
...
class ImageProcessor:
    ...
    def preprocess_image(self, image: np.ndarray) -> np.ndarray:
        """Blur and create a robust binary mask (adaptive OR Otsu)."""
